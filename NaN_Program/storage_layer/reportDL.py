...
class ReportDL():
    ...
    def add_report(self,rep):
        with open(self.csv, 'a', newline='', encoding='utf-8') as csvfile:
            fieldnames = ["Report-id","Request-id","Employee","Employee-id","Title","Description","Location","Property","Property-number","Property-id","Contractor-name","Contractor-id","Contractor-rating","Date","Commission","Status","Feedback"]
            ...
            "Contractor-name":rep.contract_name,"Contractor-id":rep.contract_id,"Contractor-rating":rep.contract_rating,"Date":rep.date,"Commission":rep.comm,"Status":rep.status,"Feedback":rep.feed})
    ...
    def change_report_info(self,rep_lis):
         with open(self.csv, 'w+', newline='',encoding='utf-8') as f:
            ...
            for dic in rep_lis:
                ...
                dic["Title"],dic["Description"],dic["Location"],dic["Property"],dic["Property-number"],dic["Property-id"],dic["Contractor-name"],dic["Contractor-id"],dic["Contractor-rating"],dic["Date"],dic["Commission"],dic["Status"],dic["Feedback"]])
