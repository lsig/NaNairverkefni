...
class JobDL:
    ...
    def add_job(self,jobinfo):
        with open(self.csv, 'a', newline='', encoding='utf-8') as csvfile:
            fieldnames = ["id","Date-created","Employee","Employee-id","Title","Description","Location","Property","Property-number","Property-id","Priority","Suggested-contractors-id","Suggested-contractors","Status","Type"]
            writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
            writer.writerow({'id': jobinfo.id, "Date-created": jobinfo.date_cr, "Employee": jobinfo.empl, "Employee-id": jobinfo.empl_id,"Title":jobinfo.titl, "Description": jobinfo.desc, "Location": jobinfo.loc,"Property":jobinfo.prop, "Property-number":jobinfo.prop_num,"Property-id":jobinfo.prop_id,"Priority":jobinfo.prior,"Suggested-contractors-id":jobinfo.sug_con_id,"Suggested-contractors":jobinfo.sug_con,"Status":jobinfo.stat,"Type":jobinfo.type})
