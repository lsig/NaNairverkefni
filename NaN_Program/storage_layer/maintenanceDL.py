...
class MaintenanceDL():
    ...
    def add_maintenance_job(self,main_job):
        with open(self.csv, 'a', newline='', encoding='utf-8') as csvfile:
            fieldnames = ["id","Date-from","Date-to","Title","Description","Location","Property","Property-number","Property-id","Employee","Employee-id","Frequency","Priority","Suggested-contractors"]
            ...
            "Property-id":main_job.property_id,"Employee":main_job.emp,"Employee-id":main_job.emp_id,"Frequency":main_job.freq,"Priority":main_job.priority,"Suggested-contractors":main_job.suggested_cont})
    ...
    def change_maintenance_job_info(self,rep_lis):
         with open("test.csv", 'w+', newline='',encoding='utf-8') as f:
            ...
            for dic in rep_lis:
                ...
                ,dic["Property-id"],dic["Employee"],dic["Employee-id"],dic["Frequency"],dic["Priority"],dic["Suggested-contractors"]])
